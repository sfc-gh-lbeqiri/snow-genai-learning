...
|---|---|---|---|
| 01 | [`01-complete-basics`](b-foundations/01-complete-basics/notebook.ipynb) | `AI_COMPLETE` | Text prompts, image analysis, prompt objects, options, model comparison |
...
| # | Lab | Functions | Description |
|---|---|---|---|
| 04 | [`04-classify-sentiment`](c-ai-functions/04-classify-sentiment/notebook.ipynb) | `AI_CLASSIFY` + `AI_SENTIMENT` | Categorization with custom labels + aspect-based sentiment analysis |
...
- **Lab 07** — Sample invoice PDFs are auto-generated by a Python cell and staged to `@invoice_pdfs`.
